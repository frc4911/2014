...
public class RobotMap {
    ...
    public static AnalogPotentiometer PneumaticCollectorPotentiometer;
    ...
    public static DigitalInput ProximitySwitch;
    ...
    public static void init() {
        ...
        PneumaticCollectorPotentiometer = new AnalogPotentiometer(RobotConstants.COLLECTOR_POTENTIOMETER_CHANNEL);
